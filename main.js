...
var AtomizerModal = class extends import_obsidian2.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian2.Setting(contentEl).addButton((btn) => btn.setButtonText(isFolder ? "Atomize all files" : "Atomize").setCta().setDisabled(!this.target).onClick(() => {
      (async () => {
        if (this.target) {
          this.close();
            ...
            for (const child of this.target.children) {
              if (child instanceof import_obsidian2.TFile && child.extension === "md") {
                try {
                  ...
                  new import_obsidian2.Notice(`Failed to atomize ${child.name}`);
                }
              }
            }
...
var SummarizerModal = class extends import_obsidian5.Modal {
  constructor(app, settings, saveSettings, target) {
    ...
    if (this.target) {
      ...
      this.targetPath = active ? ((_a = active.parent) == null ? void 0 : _a.path) || "/" : "/";
    }
  }
  async onOpen() {
    const { contentEl } = this;
  ...
  display() {
    ...
    new import_obsidian5.Setting(contentEl).addButton((btn) => btn.setButtonText("Start Summarization").setCta().onClick(() => {
      void (async () => {
        ...
        try {
          const prompts = [];
          if (this.prompt1Enabled)
            prompts.push(this.prompt);
          if (this.prompt2Enabled)
            prompts.push(this.prompt2);
          if (this.prompt3Enabled)
            prompts.push(this.prompt3);
          if (this.prompt4Enabled)
            prompts.push(this.prompt4);
          ...
          new import_obsidian5.Notice("Error during summarization.");
...
var WisdomModal = class extends import_obsidian7.Modal {
  ...
  display() {
    ...
    new import_obsidian7.Setting(contentEl).addButton((btn) => btn.setButtonText("Extract wisdom").setCta().onClick(() => {
      void (async () => {
        btn.setButtonText("Processing...").setDisabled(true);
        try {
          ...
          } else if (this.target instanceof import_obsidian7.TFolder) {
...
var DateFixModal = class extends import_obsidian9.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian9.Setting(contentEl).addButton((btn) => btn.setButtonText("Run date fix").setCta().onClick(() => {
      void (async () => {
        btn.setButtonText("Processing...").setDisabled(true);
        try {
          ...
          } else if (this.target instanceof import_obsidian9.TFolder) {
...
var ConcatonizerModal = class extends import_obsidian11.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian11.Setting(contentEl).addButton((btn) => btn.setButtonText("Concatonize").setCta().onClick(() => {
      void (async () => {
        btn.setButtonText("Processing...").setDisabled(true);
        try {
          if (this.target instanceof import_obsidian11.TFolder) {
            ...
            new import_obsidian11.Notice("Invalid target folder.");
...
var RatingModal = class extends import_obsidian13.Modal {
  ...
  display() {
    ...
    if (this.target instanceof import_obsidian13.TFolder) {
    ...
    new import_obsidian13.Setting(contentEl).addButton((btn) => btn.setButtonText("Start Rating").setCta().onClick(() => {
      void (async () => {
        btn.setButtonText("Processing...").setDisabled(true);
...
var DeduplicationModal = class extends import_obsidian15.Modal {
  ...
  renderSettings(contentEl) {
    ...
    new import_obsidian15.Setting(contentEl).addButton((btn) => btn.setButtonText("Find duplicates").setCta().onClick(() => {
      void (async () => {
  ...
  renderResults(contentEl) {
    ...
    (_c = this.duplicates) == null ? void 0 : _c.forEach((group, index) => {
      ...
      group.files.forEach((file) => {
        ...
        new import_obsidian15.Setting(actions).addButton((btn) => btn.setButtonText("Delete").setWarning().onClick(() => {
          void (async () => {
            var _a3, _b2;
...
WRI - Writing Career: #WRI`;
  ...
  onOpen() {
    ...
    new import_obsidian17.Setting(contentEl).setName("Categories").setDesc("Format: Category Name: #Tag").addTextArea((text) => {
      text.setValue(this.categoriesText).setPlaceholder("Category: #TAG").onChange((value) => this.categoriesText = value);
      text.inputEl.rows = 10;
      text.inputEl.addClass("coherence-w-100");
    });
    new import_obsidian17.Setting(contentEl).addButton((btn) => btn.setButtonText("Parse").setCta().onClick(() => {
      void this.parse();
    }));
  }
  display() {
...
var CensorModal = class extends import_obsidian19.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian19.Setting(contentEl).setName("Dictionary content").setDesc("Edit the censored words and aliases (Changes here are temporary unless saved in settings)").addTextArea((text) => {
      text.setValue(this.dictionaryText).setPlaceholder("Variant1, Variant2 = Alias").onChange((value) => this.dictionaryText = value);
      text.inputEl.rows = 10;
      text.inputEl.addClass("coherence-w-100");
    });
    new import_obsidian19.Setting(contentEl).addButton((btn) => btn.setButtonText("Process").setCta().onClick(() => {
      void this.process();
    }));
  }
  display() {
...
var ChronoMergeModal = class extends import_obsidian21.Modal {
  ...
  display() {
    ...
    if (!this.groups.length) {
      ...
      new import_obsidian21.Setting(contentEl).addButton((btn) => btn.setButtonText("Scan").setCta().onClick(() => {
        this.scan();
      }));
    } else {
...
var CategorizerModal = class extends import_obsidian24.Modal {
  ...
  async fetchModels() {
    try {
      ...
      new import_obsidian24.Notice("Failed to fetch models");
      this.ollamaModels = ["llama3", "mistral", "gemma"];
    }
  }
  display() {
    ...
    new import_obsidian24.Setting(contentEl).setName("Apply as tag").addToggle((t) => t.setValue(this.applyAsTag).onChange((v) => {
      this.applyAsTag = v;
      this.display();
    }));
    if (this.applyAsTag) {
      new import_obsidian24.Setting(contentEl).setName("Tag handling").setDesc("How to handle existing tags").addDropdown(
    ...
    new import_obsidian24.Setting(contentEl).addButton((btn) => btn.setButtonText("Start categorizing").setCta().onClick(() => {
      void (async () => {
        btn.setButtonText("Processing...").setDisabled(true);
        const progressContainer = contentEl.createDiv({ cls: "coherence-progress-container" });
        const progressBarBg = progressContainer.createDiv({ cls: "coherence-progress-bar-bg" });
...
var GeneralizerModal = class extends import_obsidian27.Modal {
  ...
  display() {
    ...
    new import_obsidian27.Setting(contentEl).addButton((btn) => btn.setButtonText("Generalize").setCta().onClick(() => {
      void this.process();
    }));
  }
  async process() {
...
var WizardView = class extends import_obsidian30.ItemView {
  ...
  async fetchModels() {
    try {
      ...
      new import_obsidian30.Notice("Failed to fetch models");
      this.availableModels = ["llama3", "mistral", "gemma"];
    }
  }
  ...
  stepDateFix(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Run Date Fix").setCta().onClick(() => {
      void (async () => {
  ...
  stepAtomize(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Atomize").setCta().onClick(() => {
      void (async () => {
  ...
  stepYaml(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Apply Template").setCta().onClick(() => {
      void (async () => {
  ...
  stepSummarize(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Summarize").setCta().onClick(() => {
      void (async () => {
  ...
  stepRate(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Rate").setCta().onClick(() => {
      void (async () => {
  ...
  stepCategorize(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Categorize").setCta().onClick(() => {
      void (async () => {
  ...
  stepMoveCopy(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Execute").setCta().onClick(() => {
      void (async () => {
  ...
  stepCombine(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Combine").setCta().onClick(() => {
      void (async () => {
  ...
  stepWisdom(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Extract").setCta().onClick(() => {
      void (async () => {
  ...
  stepFinalMerge(container) {
    ...
    new import_obsidian30.Setting(container).addButton((btn) => btn.setButtonText("Merge").setCta().onClick(() => {
      void (async () => {
...
var YamlTemplateModal = class extends import_obsidian31.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian31.Setting(contentEl).addButton((btn) => btn.setButtonText("Apply template").setCta().onClick(() => {
      void (async () => {
        btn.setButtonText("Processing...").setDisabled(true);
        ...
        try {
          ...
          } else if (this.target instanceof import_obsidian31.TFolder) {
...
var CoherenceSettingTab = class extends import_obsidian32.PluginSettingTab {
  ...
  renderContextMenuSettings(containerEl) {
    ...
    new import_obsidian32.Setting(containerEl).setName("Rating").setDesc("Available in: File, Folder").addToggle((toggle) => toggle.setValue(this.plugin.settings.contextMenuRating).onChange(async (value) => {
  ...
  renderSummarizerSettings(containerEl) {
    ...
    new import_obsidian32.Setting(containerEl).setName("Prompt 1 (General Summary)").setDesc("Initial comprehensive summary. Placeholders: {filename}, {text}").addTextArea((text) => text.setValue(this.plugin.settings.summarizerPrompt).setPlaceholder("Enter prompt...").then((t) => t.inputEl.rows = 6).onChange(async (value) => {
      ...
      await this.plugin.saveSettings();
    })).addToggle((toggle) => toggle.setValue(this.plugin.settings.summarizerPrompt1Enabled).setTooltip("Enable Prompt 1").onChange(async (value) => {
    ...
    new import_obsidian32.Setting(containerEl).setName("Prompt 2 (Concise Summary)").setDesc("Condense the summary. Placeholders: {filename}, {summary}").addTextArea((text) => text.setValue(this.plugin.settings.summarizerPrompt2).setPlaceholder("Enter prompt...").then((t) => t.inputEl.rows = 6).onChange(async (value) => {
      ...
      await this.plugin.saveSettings();
    })).addToggle((toggle) => toggle.setValue(this.plugin.settings.summarizerPrompt2Enabled).setTooltip("Enable Prompt 2").onChange(async (value) => {
    ...
    new import_obsidian32.Setting(containerEl).setName("Prompt 3 (De-fluff)").setDesc("Remove filler. Placeholders: {summary}").addTextArea((text) => text.setValue(this.plugin.settings.summarizerPrompt3).setPlaceholder("Enter prompt...").then((t) => t.inputEl.rows = 6).onChange(async (value) => {
      ...
      await this.plugin.saveSettings();
    })).addToggle((toggle) => toggle.setValue(this.plugin.settings.summarizerPrompt3Enabled).setTooltip("Enable Prompt 3").onChange(async (value) => {
    ...
    new import_obsidian32.Setting(containerEl).setName("Prompt 4 (Capitalize)").setDesc("Capitalize important words. Placeholders: {summary}").addTextArea((text) => text.setValue(this.plugin.settings.summarizerPrompt4).setPlaceholder("Enter prompt...").then((t) => t.inputEl.rows = 6).onChange(async (value) => {
      ...
      await this.plugin.saveSettings();
    })).addToggle((toggle) => toggle.setValue(this.plugin.settings.summarizerPrompt4Enabled).setTooltip("Enable Prompt 4").onChange(async (value) => {
  ...
  renderCategorizerSettings(containerEl) {
    ...
    const dictSetting = new import_obsidian32.Setting(containerEl).setName("Active Dictionary").setDesc("Select, rename, or delete dictionaries").addDropdown((drop) => {
  ...
  renderRatingSettings(containerEl) {
    ...
    new import_obsidian32.Setting(containerEl).setName("Quality Parameters").setDesc("Comma separated list of parameters to rate (e.g. coherence, profundity)").addText((text) => text.setValue(this.plugin.settings.ratingParams).onChange(async (value) => {
      this.plugin.settings.ratingParams = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian32.Setting(containerEl).setName("Skip Rated").setDesc("Skip files that already have a rating in frontmatter").addToggle((toggle) => toggle.setValue(this.plugin.settings.ratingSkipIfRated).onChange(async (value) => {
      this.plugin.settings.ratingSkipIfRated = value;
      await this.plugin.saveSettings();
    }));
  }
